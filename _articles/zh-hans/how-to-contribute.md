...
如果你是一名开源界的新手，可能会对贡献的流程心生畏惧。比如：该如何找到正确的项目？不懂编程又想参与怎么办？万一做错事情了怎么办？
...
<aside markdown="1" class="pquote">
  ...
  我被大家所熟知是因为为 CocoaPods 做了一些事, 其实大伙并不知道我实际并没有为 CocoaPods 本身做了什么，我大多数的工作是诸如编写文档、品牌宣传之类的。
  <p markdown="1" class="pquote-credit">
...
* 为项目计划研讨会或线下分享，[一如 @fzamperin 为 NodeSchool 所做的那样](https://github.com/nodeschool/organizers/Issues/406)
* 为项目计划大型会议（假如它有的话）
...
尽管你是一名软件开发者，也可以去写一些文档去帮助新的入门者。其实项目中那些看起来令人生畏的项目并不是写代码，做开发者总得挑战自己，其实在做得过程中可以增强信心和获得全新的体验。
...
> [28% 的随意贡献](https://www.igor.Pull Requesto.br/publica/papers/saner2016.pdf) 就是说明了文档的开源，诸如拼写错误，段落语句调整、或者是翻译。
...
在主干上确认提交的活跃度。在 [GitHub](https://github.com/) 上托管的开源项目，你可以在仓库主页上看到这些信息。
...
同样再来看看 Pull Request 的情形。

<div class="clearfix mb-2">
  <input type="checkbox" id="cbox10" class="d-block float-left mt-1 mr-2" value="checkbox">
  <label for="cbox8" class="overflow-hidden d-block text-normal">
    现在有多少处于开放状态的 Pull Request？
  </label>
</div>
...
<div class="clearfix mb-4">
  ...
  <label for="cbox13" class="overflow-hidden d-block text-normal">
    最近有多少 Pull Request 合并？ (在 GitHub, 点击 Pull Request 页面的 "closed" 的标签页来查看已经关闭的标签页。)
  </label>
</div>
...
<aside markdown="1" class="pquote">
  ...
  <p markdown="1" class="pquote-credit">
— @kfogel, [_开源软件生产力_](https://Pull Requestoducingoss.com/en/evaluating-oss-Pull Requestojects.html)
  </p>
</aside>
...
在你开启一个 Issue 或 Pull Request 之前，或者是在聊天室问问题之前，请牢记下面所列出的几点建议，会让你的工作更加的高效。
...
> 😇 _(评论) "@维护者 你好！我们该如何处理这个 Pull Request？"_
>
> 😢 _(邮件) "你好，非常抱歉给发信，但是我实在很希望你能看一下我提交的 Pull Request。"_
...
<aside markdown="1" class="pquote">
  ...
  你能够从单个的项目学习到 <em>很多</em> ，只要你踊跃的去使用，在GitHub上密切观察项目，并阅读每一个 Issue 和 Pull Request。
<p markdown="1" class="pquote-credit">
...
一个 Pull Request 并不代表着工作已经完成。它通常是尽早的开启一个 Pull Request，是为了其他人可以观看或者给作者反馈意见。只需要在子标题标记为"WIP"（正在进行中）。作者可以在后面添加很多评论。

如果说项目是托管在 GitHub 上的，以下是我们总结出的提交 Pull Request 的建议：

* **[Fork 代码仓库](https://guides.github.com/activities/forking/)** 并克隆到本地，在本地的仓库配置"上游"为远端仓库。这样你可以在提交你的 Pull Request 时保持和"上游"同步，会减少很多解决冲突的时间。(更多关于同步的说明，请参考[这里](https://help.github.com/articles/syncing-a-fork/).)
* **[创建一个分支](https://guides.github.com/introduction/flow/)** 用于自己编辑。
* **参考任何相关的Issue** 或者在你的 Pull Request 中支持文档(比如. "Closes #37.")
* **包含之前和之后的快照** 如果你的改动是包含了不同的 HTML/CSS。在你的 Pull Request 中加入相应的图片。
...
如果这是你第一次提交 Pull Request。可以浏览 [提交 Pull Request](http://makeapullrequest.com/)的文档，这是 @kentcdodds 专门为初次创建 Pull Request 的人写的公开的资料。
...
当有人提出变更时，请及时响应。他们花时间审核了你的提交，要尊重他们。开启 Pull Request 然后一走了之是一种恶习。如果你不知道如何修改，请花时间深入研究，并在需要时寻求他人帮助。
...
开源就是由你这样的人所铸造：一个 Issue、一个 Pull Request、一则回复、一次击掌。就是这么简单！
