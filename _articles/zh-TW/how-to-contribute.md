...
爲開源做貢獻，除了單詞拼寫錯誤之外，大多數時候就像是走在陌生人中間，渾身上下不適。這就像人們已經在西邊討論的非常深入了，你突然開始講東，肯定會讓人感到不舒服。

與其盲目的在項目中遊蕩，不如靜下心來學習規則。這樣反而會讓你的想法被注意到，也會有人聽到你的聲音。

### 分析感興趣的開源項目

每一個開源社區都是不一樣的。

在某一個開源項目紮根多年，這意味着你只是對這一個開源項目無比的熟悉。若是切換到不同的項目，可能會發現完全是另外一回事，所謂的使用詞彙、習慣用語、溝通方式都發生了變化。

然而，很多的開源項目還是遵循類似的組織結構的。理解不同的社區角色和全部的流程，可以很好的幫助你快速的切入新的項目。

一個典型的開源項目均會有如下類型的人：

* **作者:** 項目的創始人或創始組織
* **歸屬者:** 代碼倉庫或組織的管理員（不一定和作者是同一個人）
* **維護者:** 貢獻者，負責項目的未來走向和組織的管理（他們通常也是項目的作者或歸屬者。）
* **貢獻者:** 只要是爲項目做出了貢獻，就算。
* **社區成員:** 那些實用項目的人們。他們或許是積極的討論者，又或者是爲項目的方向提出意見的人。

一個較大的項目，可能下面還會細分子社區，或者是針對不同的任務分成不同的小組，比如工具小組、分流、社區事務、以及活動組織等。徑直到項目到web站點，找到“團隊”頁面，或者是查看治理文檔，從而獲得類似到信息。

靠譜的開源項目，一般都會有一個文檔的，這些文檔文件通常會在代碼倉庫的頂級目錄列出。

* **許可協議:** 根據開源軟件的定義，每一個開源項目必須是有[開源許可協議](https://choosealicense.com)的. 可以這麼認爲：假如說某個項目源碼開放，但是沒有任何的許可協議，那麼它就不能叫做開源。
* **README:**  README 是一個介紹性的說明文件，對初次光臨社區對人們表示歡迎，它通常會解釋項目有何用處，爲何發起，以及如何快速入門等。
* **貢獻:**  READMES 幫助人們來認識項目，貢獻這個文件則是幫助對項目如何做貢獻。它解釋了目前項目需要什麼樣類型對貢獻者，社區對流程是啥樣的。並非所有的項目都會有這個文件，它某種程度上也是展示項目對於貢獻者的友好程度。
* **行爲準則:** 顧名思義，即是一些參與社區時的一些禮儀、說話方式、行爲等，幫助形成一種友好的氛圍，不是所有的項目都會撰寫行爲準則文件，它某種程度上也是展示項目對於貢獻者的友好程度。
* **其它文檔:** 有些項目也許還有其它文檔，例如教程、導遊，或者是治理規則，這在大型項目中常見。

此外，開源項目還會利用如下一些工具來進行組織討論，閱讀這些歸檔對於理解社區的想法、是如何工作的有非常大的作用。

* **問題追蹤:** 這裏是人們討論項目相關問題的地方。
* **Pull requests:** 審覈代碼、以及相關的問題討論。
* **論壇或郵件列表:** 一些項目會實用會話式的主題（例如 _"How do I..."_ 或 _"What do you think about..."_ 來替代Bug報告或特性請求）。然而有一些項目關於討論全部實用問題追蹤。
* **即時在線聊天:** 有一些項目會實用聊天頻道（諸如 Slack 或 IRC），從而能夠隨意的談話、協作和快速交流。
...
無論你處於什麼樣的目的：僅僅是一次性的貢獻，亦或是永久性的加入社區，都的和他人進行溝通和交往，這是你要在開源圈發展必須修煉的技能。
