...
一個友善、溫暖的開源社群會讓人們持續的參與。可能是在一次的技術研討中，也可能是在線上聊天室的閒聊中發生，許多人透過參與開源建立了深厚的友誼。
...
你不一定要持續不斷的貢獻開源才能享受參與的樂趣。你是否曾在某個網站上發現拼寫錯誤，並希望有人能夠修改它？在開源專案中你可以親自修正這樣的錯誤即可。開源讓人們自在的做事，而這才是這個世界應有的體驗。
