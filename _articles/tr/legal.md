...
toc:
  ...
  which-open-source-license-is-appropriate-for-my-project: Projem için hangi açık
    kaynak lisansı uygundur?
  what-if-i-want-to-change-the-license-of-my-project: Projemin lisansını değiştirmek
    istersem ne olur?
  does-my-project-need-an-additional-contributor-agreement: Projemin ek bir katkı
...
- **Ticari Markalar:** Projenizin adının [mevcut hiçbir ticari marka ile çakışmadığından](../starting-a-project/#avoiding-name-conflicts) emin olun. Projede kendi şirket ticari markalarınızı kullanıyorsanız, herhangi bir anlaşmazlık yaratmadığını kontrol edin. [FOSSmarks](http://fossmarks.org/) , markaları ücretsiz ve açık kaynaklı projeler bağlamında anlamak için pratik bir rehberdir.
