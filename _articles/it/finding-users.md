...
Ad esempio, @robb utilizza esempi di codice per comunicare chiaramente il motivo del suo progetto, [Cartography](https://github.com/robb/Cartography), e utile:

![Cartography README](/assets/images/finding-users/cartography.jpg)

Per un approfondimento sulla messaggistica, vedere l'esercizio Mozilla ["Persone e percorsi"](https://mozillascience.github.io/working-open-workshop/personas_pathways/) per sviluppare i personaggi degli utenti.
...
— Peter Cooper & Robert Nyman, ["Как да разпространявате информация за своя кодCome distribuire le informazioni sul tuo codice"](https://hacks.mozilla.org/2013/05/how-to-spread-the-word-about-your-code/)
  </p>
</aside>
...
[@adrianholovaty](https://news.ycombinator.com/item?id=7531689), co-creatore di Django, ha detto che il sito web è stato _"di gran lunga la cosa migliore che abbiamo fatto con Django nei primi giorni"_.
...
Se sei [nuovo nel parlare in pubblico](https://speaking.io/), inizia trovando un incontro locale pertinente alla lingua o all'ecosistema del tuo progetto.
...
<aside markdown="1" class="pquote">
  ...
  <p markdown="1" class="pquote-credit">
— @ry, ["La storia di Node.js" (video)](https://www.youtube.com/watch?v=SAc0vQCC6UQ&t=24m57s)
  </p>
</aside>
