...
<aside markdown="1" class="pquote">
  ...
  <p markdown="1" class="pquote-credit">
    — @gvanrossum, ["Programazione di Python"](https://www.python.org/doc/essays/foreword/)
  </p>
</aside>
...
<aside markdown="1" class="pquote">
  ...
  <p markdown="1" class="pquote-credit">
    — @alloy, ["Perche non accetiamo donazioni"](https://blog.cocoapods.org/Why-we-dont-accept-donations/)
  </p>
</aside>
...
<aside markdown="1" class="pquote">
  <img src="https://avatars.githubusercontent.com/isaacs?s=180" class="pquote-avatar" alt="avatar">
   L’OSS apporta enormi vantaggi al settore tecnologico, che a loro volta si traducono in vantaggi per tutti i settori. (...) Tuttavia, se le uniche persone che possono concentrarsi su questo sono i fortunati e gli ossessionati, allora c'è un enorme potenziale non sfruttato.
  <p markdown="1" class="pquote-credit">
...
* Alcune compagnie, come [Netflix](https://netflix.github.io/) o [PayPal](https://paypal.github.io/), hanno siti Web, che evidenziano il loro coinvolgimento nell’open source
* [Zalando](https://opensource.zalando.com) pubblica la sua [politica di contributo open source](https://opensource.zalando.com/docs/using/contributing/) per dipendenti

Progetti che nascono da una grande azienda, come [Go](https://github.com/golang) o [React](https://github.com/facebook/react), probabilmente impiegherà anche persone per lavorare sull'open source.
...
* @Homebrew (e [molte altre organizzazioni e supporto](https://github.com/sponsors/community)) finanziare il loro lavoro attraverso [Sponsor di GitHub](https://github.com/sponsors)
* @gaearon ha finanziato il suo lavoro [Redux](https://github.com/reactjs/redux) tramite [campagna di crowdfunding su Patreon](https://redux.js.org/)
* @andrewgodwin ha finanziato il lavoro sulle migrazioni dello schema Django [attraverso una campagna Kickstarter](https://www.kickstarter.com/projects/andrewgodwin/schema-migrations-for-django)

Infine, a volte i progetti open source offrono premi per problemi che potresti considerare di aiutare.

* @ConnorChristie è riuscito a essere pagato per [aiuto](https://web.archive.org/web/20181030123412/https://webcache.googleusercontent.com/search?strip=1&q=cache:https%3A%2F%2Fgithub.com%2FMARKETProtocol%2FMARKET.js%2Fissues%2F14) @MARKETProtocol lavorando sulla loro libreria JavaScript [tramite ricompensa gitcoin](https://gitcoin.co/).
* @mamiM ha realizzato traduzioni giapponesi per @MetaMask dopo [la pubblicazione è stata finanziata da Bounties Network](https://explorer.bounties.network/bounty/134).
...
* **[webpack](https://github.com/webpack)** raccoglie denaro da aziende e privati [tramite OpenCollective](https://opencollective.com/webpack)
...
* **[Leggi i documenti](https://github.com/rtfd/readthedocs.org)** ha ricevuto un finanziamento da [Mozilla Open Source Support](https://www.mozilla.org/en-US/grants/)
* Il lavoro su **[OpenMRS](https://github.com/openmrs)** è finanziato da [Stripe Open Source Retreat](https://stripe.com/blog/open-source-retreat-2016-grantees)
...
* **[Python Software Foundation](https://www.python.org/psf/grants/)** offre sovvenzioni per lavori relativi a Python
