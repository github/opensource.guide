...
* **Se c'è un contributo con cui non sei d'accordo,** ringrazialo per la sua idea e [spiega perché](../best-practices/#impara-a-dire-di-no) non soddisfa lo scopo del progetto, con un collegamento alla documentazione pertinente, se disponibile.
...
[Questo è ciò che ha scoperto uno studio di Mozilla](https://docs.google.com/presentation/d/1hsJLv1ieSqtXBzd5YZusY-mB8e1VJzaeOmh8Q4VeMio/edit#slide=id.g43d857af8_0177) i contributori che hanno ricevuto revisioni del codice entro 48 ore hanno avuto un tasso di rendimento e ricontribuzione molto più elevato.
...
Nel tuo file CONTRIBUTING, indica esplicitamente ai nuovi contributori come iniziare. Potresti anche voler creare una sezione speciale per questo scopo. [Django](https://github.com/django/django), ad esempio, esiste una landing page dedicata per accogliere i nuovi contributori.

![Django nuova pagina dei contributori](/assets/images/building-community/django_new_contributors.png)

Nella coda degli argomenti, contrassegna i bug appropriati per i diversi tipi di contributori: ad esempio [_"per principianti"_](https://kentcdodds.com/blog/first-timers-only), _"buon primo argomento"_ o _"documentazione"_. [Questi segni](https://github.com/librariesio/libraries.io/blob/6afea1a3354aef4672d9b3a9fc4cc308d60020c8/app/models/github_issue.rb#L8-L14) rendendo facile per qualcuno che non conosce il tuo progetto scansionare rapidamente i tuoi argomenti e iniziare.

Сигурен съм, че ще ви разкажа историята, ще го направя отново.

Нека ти кажа каква е историята, как я искаш. Да видим какво се е случило. Нека ви разкажа, нека ви разкажа, нека ви разкажа Нека поговорим за историята на историята. Нека ви кажа какво да правите, ето историята.

Ad esempio, ecco come [Rubinius](https://github.com/rubinius/rubinius/) inizia [la sua Guida per i contributi](https://github.com/rubinius/rubinius/blob/HEAD/.github/contributing.md):
...
<aside markdown="1" class="pquote">
  ...
  <p markdown="1" class="pquote-credit">
— @sagesharp, ["Cosa rende una buona comunità?"](https://sage.thesharps.us/2015/10/06/what-makes-a-good-community/)
  </p>
</aside>
...
* **Evita di correggere bug facili (non critici).** Usali invece come opportunità per reclutare nuovi contributori o fare da mentore a qualcuno che vorrebbe contribuire. All’inizio può sembrare innaturale, ma il tuo investimento verrà ripagato nel tempo. Ad esempio, @michaeljoseph ha chiesto a un collaboratore di inviare una richiesta pull per il problema [Cookiecutter](https://github.com/audreyr/cookiecutter) riportato di seguito invece di risolverlo da solo.

![Cookiecutter issue](/assets/images/building-community/cookiecutter_submit_pr.png)

* **Avvia un file CONTRIBUTORI o AUTORI nel tuo progetto** che elenca tutti coloro che hanno contribuito al tuo progetto mentre lo fa [Sinatra](https://github.com/sinatra/sinatra/blob/HEAD/AUTHORS.md).

* Se hai una community numerosa, **invia una newsletter o scrivi un post sul blog** ringraziando i contributori. [Questa settimana a Rust](https://this-week-in-rust.org/) di Rust e [Shoutouts](http://hood.ie/blog/shoutouts-week-24.html) di Hoody sono due buoni esempi.

* **Concedi l'accesso al commit a ogni collaboratore.** @felixge ha scoperto che questo rende le persone [più entusiaste di migliorare le proprie soluzioni](https://felixge.de/2013/03/11/the-pull-request-hack.html) e ha anche trovato nuovi sostenitori per progetti su cui non lavorava da un po'.

* Se il tuo progetto è su GitHub, **sposta il tuo progetto dal tuo account personale a [Organizzazione](https://help.github.com/articles/creating-a-new-organization-account/)** e aggiungere almeno un amministratore di backup. Le organizzazioni facilitano il lavoro di progetto con collaboratori esterni.
...
Il voto può diventare politico quando i membri della comunità si sentono spinti a fare favori o a votare in un certo modo. Non tutti votano, siano essi [la maggioranza silenziosa](https://ben.balter.com/2016/03/08/optimizing-for-power-users-and-edge-cases/#the-silent-majority-of-users) nella tua comunità o degli utenti attuali che non sapevano che si stava svolgendo una votazione.

A volte è richiesto un voto di parità. Tuttavia, per quanto puoi, enfatizza [la "ricerca del consenso"](https://en.wikipedia.org/wiki/Consensus-seeking_decision-making), piuttosto che il consenso.
...
<aside markdown="1" class="pquote">
  ...
  Parte del motivo per cui non esiste un sistema di voto per gli argomenti Atom è che il team Atom non seguirà un sistema di voto in tutti i casi. A volte dobbiamo scegliere ciò che riteniamo giusto, anche se non è popolare. (...) Ciò che posso offrire e mi impegno a fare... è che il mio lavoro è ascoltare la comunità.
  <p markdown="1" class="pquote-credit">
...
## La community è ❤️ del open source
