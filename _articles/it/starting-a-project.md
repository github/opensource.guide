...
### Perché le persone rendono open source il proprio lavoro?
...
Non esiste una risposta giusta a questa domanda. Puoi avere più obiettivi per un progetto o progetti diversi con obiettivi diversi.
...
Se non sei sicuro di come iniziare come collaboratore, consulta la nostra [Guida su come contribuire all'open source](../how-to-contribute/).
...
[MIT](https://choosealicense.com/licenses/mit/), [Apache 2.0](https://choosealicense.com/licenses/apache-2.0/) e [GPLv3](https://choosealicense.com/licenses/gpl-3.0/) sono le licenze open source più popolari, ma [ci sono altre opzioni](https://choosealicense.com) tra cui scegliere.
...
Per ulteriore ispirazione, prova a utilizzare la [guida Make a README](https://www.makeareadme.com/) o @[README template](https://gist.github.com/PurpleBooth/109311bb0361f32d87a2) PurpleBooth di @dguo per scrivere un README completo.
...
* Come inviare una segnalazione di bug (prova a utilizzare [modelli di richiesta di problema e pull](https://github.com/blog/2111-issue-and-pull-request-templates))
...
Ad esempio, [Active Admin](https://github.com/activeadmin/activeadmin/) avvia [la sua guida ai contributi](https://github.com/activeadmin/activeadmin/blob/HEAD/CONTRIBUTING.md) con:
...
Per ulteriore assistenza nella scrittura del file CONTRIBUTING, consulta @nayafia [modello guida per la collaborazione](https://github.com/nayafia/contributing-template/blob/HEAD/CONTRIBUTING-template.md) o @mozilla ["Как да Създайте CONTRIBUTING.md"](https://mozillascience.github.io/working-open-workshop/contributing/).

Collega il tuo file CONTRIBUTE dal tuo README in modo che più persone possano vederlo. Se [metti il ​​file CONTRIBUTING nel repository del tuo progetto](https://help.github.com/articles/setting-guidelines-for-repository-contributors/), GitHub si collegherà automaticamente al tuo file quando un collaboratore pubblica o apre una richiesta pull.
...
<div class="clearfix mb-2">
  ...
  <label for="cbox2" class="overflow-hidden d-block text-normal">
    Il progetto dispone di documentazione di base (README, CONTRIBUTING, CODE_OF_CONDUCT)
  </label>
</div>
...
<div class="clearfix mb-2">
  ...
  <label for="cbox3" class="overflow-hidden d-block text-normal">
    Il nome è facile da ricordare, dà un'idea di ciò che fa il progetto e non è in conflitto con un progetto esistente né viola i marchi
  </label>
</div>
