...
왜 사람들은 오픈소스에 기여할까요? 이에는 많은 이유가 있습니다!

### 기존 기술 향상

만약 당신이 코딩, 사용자 인터페이스 디자인, 그래픽 디자인, 글쓰기 또는 조직화등의 기여를 원한다면 오픈소스 프로젝트에 관련된 일들이 있습니다.

### 비슷한 것에 관심이있는 사람들을 만나십시오

서로 존중하고 화기애애한 분위기의 커뮤니티를 가진 오픈소스 프로젝트는 수년이 지나도 사람들이 다시 방문하기 마련입니다. 많은 사람들이 부리토에 관한 회의나 심야 온라인 채팅를 가지고 서로를 실행하고 있든간에 오픈소스에 참여함으로써 평생동안 우정을 나누고 있습니다.
...
오픈소스에 기여하다보면, 사람들간의 충돌 해결, 사람들의 팀 구성 및 작업 우선순위 지정과 같은 리더십 및 관리와 같은 경험을 할 수 있습니다.
...
"오픈소스"는 종종 소프트웨어를 의미하지만, 소프트웨어가 아닌 것들도 공유하여 함께 만들어나갈 수 있습니다. 실제로 오픈소스 프로젝트로 개발되는 책, 요리법, 목록 및 수업이 존재합니다.
...
* @stuartlynn과 @nicole-a-tesla는 [collection of fun facts about puffins](https://github.com/stuartlynn/puffin_facts)를 만들었습니다
 ...
 당신이 코드를 작성하는 개발자일지라도, 문서 프로젝트 작업은 오픈소스에 입문하는 데 도움이 될 수 있습니다. 코드를 포함하지 않는 프로젝트에서 작업하는 것은 부담이 적고 위험하지 않기 때문에, 사람들과 함께 작업해보면서 자신감과 경험을 기를 수 있습니다.
...
하나의 오픈소스 프로젝트에 수년동안 기여하고 활동했다는 것은 하나의 오픈소스 프로젝트를 알게되었다는 것을 의미합니다. 그러나 다른 프로젝트로 이동하면 어휘, 규범 및 의사 소통 스타일이 기존의 프로젝트와는 완전히 다르다는 것을 알게됩니다.

하지만, 많은 오픈소스 프로젝트는 비슷한 조직 구조를 따릅니다. 따라서  커뮤니티의 역할과 전반적인 프로세스를 이해하면 새로운 프로젝트를 신속하게 수행할 수 있습니다.

일반적인 오픈소스 프로젝트에는 아래와 같은 유형의 사람들이 있습니다:
