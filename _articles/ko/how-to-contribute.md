...
모든 오픈소스 저작물은 공개되어 있으므로, 누구에게나 보여줄 수 있는 예시를 얻게 되는 것입니다.
...
"오픈소스"는 종종 소프트웨어를 의미하지만, 무엇이든 콜라보 할 수 있습니다. 오픈소스 프로젝트로 개발되는 책, 요리법, 목록 및 수업도 존재합니다.
