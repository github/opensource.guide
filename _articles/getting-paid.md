...
Finally, there are also open source projects which put bounties on issues that you might consider helping with. Many of the organizations funding their projects also use bounty platforms for recruiting. For example: 
