...
* **Кіраванне:** Асабліва тады, калі мае сэнс перавесці праект у [юрыдычную асобу па-за межамі кампаніі](../leadership-and-governance/#ці-патрэбна-мне-юрыдычная-асоба-для-падтрымкі-майго-праекта).
