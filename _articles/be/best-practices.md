...
Дастаткова 1-2 сказаў для адказу. Напрыклад, калі карыстальнік [celery](https://github.com/celery/celery/) паведаміў пра памылку, звязаную з Windows, @berkerpeksag [адказаў](https://github.com/celery/celery/issues/3383):

![Скрыншот з Celery](/assets/images/best-practices/celery.png)

Калі думка пра тое, каб сказаць «не», палохае вас, вы не самотныя. Як [выказаўся](https://blog.jessfraz.com/post/the-art-of-closing/) @jessfraz:
...
Не адчувайце сябе вінаватым з-за таго, што не хочаце прымаць чыйсьці ўклад. Першае правіла опенсорсу, [згодна](https://twitter.com/solomonstre/status/715277134978113536) @shykes: _«Не — часова, так — назаўжды»._ Спачуваць энтузіязму іншага чалавека — гэта добра, адмаўляцца ад яго ўкладу не значыць адхіляць яго аўтара.
...
<aside markdown="1" class="pquote">
   ...
   <p markdown="1" class="pquote-credit">
- @edunham, [«Аўтаматызацыя супольнасці Rust»](https://web.archive.org/web/20161020132400/https://edunham.net/2016/09/27/rust_s_community_automation.html)
   </p>
</aside>
