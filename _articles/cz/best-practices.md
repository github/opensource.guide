---
lang: cz
title: Nejlepší cvičení pro správce
description: Dělání svého života lepším jako Open source správce, od dokumentování procesů k posilování své komunity.
...
## Co to znamená být správce?

Pokud spravujete Open source projekt, co používá hodně lidí, můžete zaznamenta, že méně píšete kód a více odpovídáte na potíže. 

V ranných fázích svého projektu, experimentujete s novými nápadady a s děláním rozhodnutí založených na tom, co chcete. Jak Váš projekt nabírá na popularitě zjistíte, že více komunikujete s uživateli a přispěvateli.

Spravování projektu vyžaduje více než psaní kódu. Tyto úkoly jsou obvykle nepředvídané ale jsou tak důležité jako je rozšiřování projektu. Schromáždili jsme několik způsobů, jak udělat Váš život lehčí, od dokumentování procesů k posilování své komunity.

## Dokumentování procesů

Dokumentování věcí je jedo z nejdůležitějších věcí, které můžete udělat jako správce.

Dokumentace nejen, že objasňuje vaše vlastní myšlení, ale pomáhá i ostatním lidem pochopit, co potřebujete nebo co očekávat. Ještě dříve, než se zeptají. 

Dokumentování věcí dělá jednoduším říct ne pokud něco nepasuje do vašeho projektu. Také to dělá jednoduší pro lidi, kteří vám pomohou. Nikdy nevíte, kdy si čte nebo používá váš projekt. 

Dokonce pokud používáte odstavce, psaní odrážek je lepší než nenapsání ničeho. 

Pamatujte na uchovávání dokumentace v nejnovějším stavu. Pokud nejste schopni jí v tomto stavu udržet, vymažte jí nebo označte dokumentaci tak, aby bylo na první pohled poznat, že přispěvatele jsou vítaní.

### Sepište vizi vašeho projektu.

Začněte se sepisováním cílů vašeho projektu. Vlže je do README nebo vytvořte oddělenný soubor s názmen VISION. Pokud máte nějaké jiné artefakty, které mohou pomoci udělejte je také veřejné. 

Pokud máte čistou, zdokumentovanou vizi můžete se soustředit na řešení problémů ostatních přispěvatelů. 

Například, @lord objevil, že jasná vize mu pomuhla rozhodnout na jaké žádosti začít pracovat první. [Slate](https://github.com/lord/slate).
...
Sepsaní pravidel může být dosti na nervy. Občas se můžete cítit jako že děláte policejní dozor ostatním a ničíte všechnu zábavu.
