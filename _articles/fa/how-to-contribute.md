...
> [28% از مشارکت‌کننده‌های معمولی](https://www.ime.usp.br/~gerosa/papers/saner2016.pdf) روی اسناد پروژه‌ی متن باز مانند اصلاح غلط‌های املائی، شکل ‌دهی مجدد، یا نوشتن ترجمه مشارکت می‌کنند.
