...
For example, imagine you're having a potluck. Your friend Lisa makes a cherry pie to share. Everybody tries the pie (_use_). It's a hit. They ask Lisa for the recipe, which she gladly provides (_view_). One friend, Joe, asks if he can use it for a dinner next week (_distribute_). Another friend, Alex, who's a pastry chef, looks at the recipe and suggests increasing the amount of butter to make a flakier crust (_modify_).
...
* **Adoption and remixing:** Open source projects can be used by anyone for any purpose. That means more people are likely to use your project, or even build something else with it. (Did you know [WordPress](https://github.com/WordPress) started as a fork of an existing project called [b2](https://github.com/WordPress/book/blob/master/Content/Part%201/2-b2-cafelog.md)?)
...
[People open source their work for many reasons](http://ben.balter.com/2015/11/23/why-open-source/), whether it's showing off their portfolio or finding people to collaborate with.
...
Not sure whether you're ready to launch? There is no ideal time to open source your work.

You can open source an idea, a work in progress, or after years of being closed source. You should open source your project when you feel comfortable having others view, and give feedback on, your work.
...
No matter which stage you decide to open source your project, every project should include the following:

* [License](https://help.github.com/articles/open-source-licensing/#where-does-the-license-live-on-my-repository)
...
For more inspiration, try using @18F's ["Making READMEs Readable" template](https://pages.18f.gov/open-source-guide/making-readmes-readable/) to write a complete README. You can also check out @matiassingers' list of [awesome READMEs](https://github.com/matiassingers/awesome-readme).
...
* How to file a bug report (you can use [issue and pull request templates](https://github.com/blog/2111-issue-and-pull-request-templates))
