...
[![Build Status](https://travis-ci.org/primer/primer-box.svg?branch=master)](https://travis-ci.org/primer/primer-box)
...
Use `counter-gray` for a counter with a gray background and white text.
...
Use `counter-gray-light` for a counter with a light gray background and dark gray text.
...
<div class="Box">
  <div class="Box-header">
    <h3 class="Box-title">
      Box title
      <span class="counter Counter--gray-light">12</span>
    </h3>
  </div>
  <div class="Box-body">
    Box body
